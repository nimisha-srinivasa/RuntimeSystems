...
public class UserResourceTest {
	...
	public void newUserTest_badRequest(){
		User user1=new User("1","Nimisha", "Srinivasa", "Nimisha Srinivasa", "nimisha_srinivasa");
		Response response = service.path("rest/users").request(
				MediaType.APPLICATION_JSON).post(Entity.entity(user1,MediaType.APPLICATION_JSON),Response.class);
	...
	public void getUserByIdTest(){
		...
		String userId="2";
		User user1=new User(userId,"Nimisha", "Srinivasa", "Nimisha Srinivasa", "nimisha_srinivasa@cs.ucsb.edu");
		Response response = service.path("rest/users").request(
				MediaType.APPLICATION_JSON).post(Entity.entity(user1,MediaType.APPLICATION_JSON),Response.class);
